...
module.exports = function (io) {
  ...
  router.post('/', async (req, res) => {
    ...
    try {
      ...
      io.emit('noteUpdated', savedNote); // Emit the note update to all connected clients
  ...
  router.put('/:id', async (req, res) => {
    try {
      ...
      io.emit('noteUpdated', updatedNote); // Emit the updated note
  ...
  router.delete('/:id', async (req, res) => {
    try {
      ...
      io.emit('noteUpdated', { id: req.params.id, deleted: true }); // Notify clients about the deleted note
