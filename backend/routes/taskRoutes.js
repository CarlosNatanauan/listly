...
module.exports = function (io) {
  ...
  router.post('/', async (req, res) => {
    ...
    try {
      ...
      io.emit('taskUpdated', newTask); // Emit the new task to all clients
  ...
  router.delete('/:id', async (req, res) => {
    try {
      ...
      io.emit('taskUpdated', { id: req.params.id, deleted: true });
      console.log('Deleted task emitted: ', { id: req.params.id, deleted: true });
